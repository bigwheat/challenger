...
public class StockTransferSearchPresenterImpl extends MvpPresenterImpl<StockTransferSearchView> implements StockTransferSearchPresenter {


    @Inject
    public StockTransferSearchPresenterImpl() {
